...
/*
#define CLR_HEADINGS          (OP_BASE + 81)
#define CLR_WELCOME           (OP_BASE + 82)
#define CLR_CELL_SELECTION    (OP_BASE + 83)
#define CLR_CELL_SELECTION_SC (OP_BASE + 84)
#define CLR_NUMB              (OP_BASE + 85)
#define CLR_STRG              (OP_BASE + 86)
#define CLR_DATEF             (OP_BASE + 87)
#define CLR_EXPRESSION        (OP_BASE + 88)
#define CLR_INFO_MSG          (OP_BASE + 89)
#define CLR_ERROR_MSG         (OP_BASE + 90)
#define CLR_MODE              (OP_BASE + 91)
#define CLR_CELL_ID           (OP_BASE + 92)
#define CLR_CELL_FORMAT       (OP_BASE + 93)
#define CLR_CELL_CONTENT      (OP_BASE + 94)
#define CLR_INPUT             (OP_BASE + 95)
#define CLR_NORMAL            (OP_BASE + 96)
#define CLR_CELL_ERROR        (OP_BASE + 97)
#define CLR_CELL_NEGATIVE     (OP_BASE + 98)
#define CLR_FG                (OP_BASE + 99)
#define CLR_BG                (OP_BASE + 100)
#define CLR_TYPE              (OP_BASE + 101)
#define CLR_BOLD              (OP_BASE + 102)
#define CLR_DIM               (OP_BASE + 103)
#define CLR_REVERSE           (OP_BASE + 104)
#define CLR_STANDOUT          (OP_BASE + 105)
#define CLR_BLINK             (OP_BASE + 106)
#define CLR_UNDERLINE         (OP_BASE + 107)
*/
