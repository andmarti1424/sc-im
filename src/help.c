...
"            b           if in beggining of a word, moves to beggining of previous word. otherwise, moves to beggining",
...
"            db          if in beggining of a word, deletes until beggining of previous word. otherwise, deletes until",
"                        beggining of word under the cursor",
"            daw         deletes word under the cursor",
"            dE          deletes until end of WORD",
"            dW          deletes until beggining of next WORD",
"            dB          if in beginning of a word, deletes until beggining of previous WORD. otherwise, deletes until",
