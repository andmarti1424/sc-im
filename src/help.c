...
"                        zap (hide) row number '8'.",
"            ZcAD , where 'AD' is a column name:",
"                        zap (hide) column 'AD'.",
"            Sr12 , where '12' is a row number:",
"                        This shows a row which was previously hidden with Zr command.",
"            ScAB , where 'AB' is a column name:",
"                        This shows a column which was previously hidden with Zc command.",
"",
"",
"",
"        INSERT MODE",
